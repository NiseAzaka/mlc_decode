...
def _get_kernel(batch, heads, kv_heads, kv_ctx, dim, pe_dim):
    ...
    return flashattn(batch, heads, kv_heads, kv_ctx, dim, pe_dim, block_n, block_h, num_split, softmax_scale)
...
def main(
    ...
    kernel = _get_kernel(batch, heads, kv_heads, kv_ctx, dim, pe_dim)
